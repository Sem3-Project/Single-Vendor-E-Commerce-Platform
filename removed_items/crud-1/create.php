...
$product_name= $price= $varient_1=$varient_2=$quantity = "";
$product_name_err =$price_err= $varient_1_err=$varient_2_err=$quantity_err = "";
$mysqli=new mysqli("localhost", "root", "", "single");
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($product_name_err) && empty($description_err) && empty($weight_err)&&empty($dimension_err) && empty($sku_err) && empty($price_err)&&empty($varient_1_err) && empty($varient_2_err) && empty($quantity_err)){
        ...
        $sql="INSERT INTO product_varient (`product_name`,`price`,`varient_1`,`varient_2`,`quantity`) VALUES (?,?,?,?,?)";
        ...
        mysqli_stmt_bind_param($stmt, "sss", $param_product_name, $param_price ,$param_varient_1, $param_varient_2, $param_quantity);
