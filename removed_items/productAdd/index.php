        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = $sql = "select product_id,product_name,description,weight,dimension,product.category_id,category.category_name,
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo"<td>";
                                        echo "<a href='update.php?product_id=". $row['product_id'] ."' title='Varient' data-toggle='tooltip'><labeL>varient</label></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
