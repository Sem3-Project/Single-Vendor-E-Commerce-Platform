            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="createVarient.php" class="btn btn-success pull-right">Add New Varient</a>
                        <!-- <a href="createVarient.php?product_id=".$product_id. class="btn btn-success pull-right">Add New Varient</a> -->
