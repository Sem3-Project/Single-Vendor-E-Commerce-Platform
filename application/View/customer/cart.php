                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method='post' action='cart.php'>
                            ...
                            <center>
                                <p style="background-color:black; color:white; height:40px; padding:10px"><label style="font-size:17px; color:white"> Total : </label> $<input type="text" name="price" id="price" readonly style="border:1px solid black;background-color:black;" /></p>
                            </center>
