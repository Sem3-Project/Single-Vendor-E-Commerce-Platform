...
<!DOCTYPE html>
    ...
    <body>
        ...
        <br><br>
        &nbsp;&nbsp;&nbsp;<input type="num" placeholder="Enter Order ID" name="order_id" >&nbsp;<input type="submit" class="link" name="Search" style="margin-bottom: 30px; width:10%; height:30px;background-color:  rgb(236, 185, 17);" value="Search"> 
        ...
        <td> <select name="delivery_status" value= <?php echo $row['delivery_status']?>>
            <option value="yes">yes</option>
            <option value="no">no</option>
            <option value="in_transit">in_transit</option>
            </select> </td>
            <td><input type="text" placeholder="Add addtional notes" name="additional_notes" value="<?php echo $row['additional_notes'] ?>"
             > </td>
