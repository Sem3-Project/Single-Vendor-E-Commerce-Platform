...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        if($data_check){
            ...
            $mail->Username = 'krishalikar@gmail.com';   // SMTP username 
            $mail->Password = 'Puppy#52';   // SMTP password 
            ...
            $sender = "From: krishalikar@gmail.com";
            if($mail->send()){
...
if(isset($_POST['login'])){
    $email = mysqli_real_escape_string($con, $_POST['email']);
    $password = mysqli_real_escape_string($con, $_POST['password']);
    $check_email_customer = "SELECT * FROM customer WHERE email = '$email'";
    $res = mysqli_query($con, $check_email_customer);
